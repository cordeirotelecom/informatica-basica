...
### **Objetivo Geral:**
Promover empoderamento e crescimento pessoal através de design no word: convites e cartões, aplicando conhecimentos práticos para uso profissional e pessoal.
...
### **Arquivo Principal:**
- **Nome:** `design_no_word_convites_e_cartões_{nome_aluna}.docx`
...
### **Atividade Seguinte:**
Atividade 05 (próxima data do cronograma)
