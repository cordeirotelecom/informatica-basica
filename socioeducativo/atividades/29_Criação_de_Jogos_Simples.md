...
### **Objetivo Geral:**
Desenvolver competências técnicas e de liderança através de criação de jogos simples, aplicando conhecimentos práticos para uso profissional e pessoal.
...
### **Arquivo Principal:**
- **Nome:** `criação_de_jogos_simples_{nome_aluno}.docx`
...
### **Atividade Seguinte:**
Atividade 30 (próxima data do cronograma)
