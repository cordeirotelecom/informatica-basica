...
### **Objetivo Geral:**
Desenvolver competências técnicas e de liderança através de informática básica: hardware e software, aplicando conhecimentos práticos para uso profissional e pessoal.
...
### **Arquivo Principal:**
- **Nome:** `informática_básica_hardware_e_software_{nome_aluno}.docx`
...
### **Atividade Seguinte:**
Atividade 06 (próxima data do cronograma)
