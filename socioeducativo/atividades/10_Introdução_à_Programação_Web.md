...
### **Objetivo Geral:**
Desenvolver competências técnicas e de liderança através de introdução à programação web, aplicando conhecimentos práticos para uso profissional e pessoal.
...
### **Arquivo Principal:**
- **Nome:** `introdução_à_programação_web_{nome_aluno}.docx`
...
### **Atividade Seguinte:**
Atividade 11 (próxima data do cronograma)
